...
import { EyeIcon, EyeSlashIcon, KeyIcon, PhoneIcon } from '@heroicons/react/20/solid'
...
import { registerUser } from '../lib/action/authActions'
	...
	return (
		<form onSubmit={handleSubmit(saveUser)} className='grid grid-cols-2 gap-3 p-2 place-self-stretch shadow border rounded-md'>
			...
			<Controller
				...
				render={({ field }) => (
					<Checkbox
						...
						onBlur={field.onBlur}
						className='col-span-2'>I Accept the <Link href='/terms'>Terms</Link>
					</Checkbox>
				)}
			/>
			...
			<div className='flex justify-center col-span-2'>
				...
				<Button className='w-64' color='primary' type='submit'>Submit</Button>
			</div>
		</form>
	)
}
